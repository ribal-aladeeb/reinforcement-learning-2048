...
advantage_estimator = torch.nn.Linear(64, 4) # this branch estimates the action value of A(s,a)
state_value_estimator = torch.nn.Linear(64, 1) # this branch estimates V(s)
